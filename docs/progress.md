...
- Repository publication is still pending: Git transport has no write credentials. The connected GitHub app sees an empty repository; automatic approval review rejected initializing its default branch because authorization covered the review branch. No remote write succeeded.
